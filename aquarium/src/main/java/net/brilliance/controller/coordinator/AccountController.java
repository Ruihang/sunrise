...
public class AccountController {
	...
	@PostMapping("add")
	public String add(@Valid @ModelAttribute UserProfile userDTO, Errors errors, RedirectAttributes ra) {
		if (errors.hasErrors()) {
			return ADD_USER_VIEW_NAME;
		}
	...
	@PatchMapping("add")
	public String update(@Valid @ModelAttribute UserProfile userDTO, Errors errors, RedirectAttributes ra) {
		if (errors.hasErrors()) {
			return ADD_USER_VIEW_NAME;
		}
